...
import { FiSearch, FiArrowUp, FiArrowDown, FiDroplet, FiWind, FiActivity } from "react-icons/fi"; // Importing react-icons
import { useDispatch, useSelector } from "react-redux";
import { get5DaysForecast, getCityData } from "./store/slices/whetherSlice";
    ...
    <div className="background">
      <div className="box">
        ...
        <form autoComplete="off" onSubmit={handleCitySearch}>
          <label>
            <FiSearch size={20} /> {/* Replaced with react-icons */}
          </label>
          <input
            type="text"
                      ...
                      {citySearchData && citySearchData.data ? (
                        <div className="weather-details-container">
                          ...
                          <div className="metrices">
                            ...
                            <div className="key-value-box">
                              <div className="key">
                                <FiWind size={20} className="icon" /> {/* Replaced with react-icons */}
                                <span>Wind</span>
                              </div>
                              <div className="value">
